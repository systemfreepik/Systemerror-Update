...
def start(update, context):
    ...
    buttons.buildbutton("Chat Group", "https://t.me/systemerrorbdchat")
...
'''
        ...
        sendMarkup('Not Authorized user, Contact With @MR_ERR0RR', context.bot, update.message, reply_markup)
...
def bot_help(update, context):
    button = ButtonMaker()
    button.buildbutton("Other Commands", f"https://telegra.ph/Bot-Command-03-15")
